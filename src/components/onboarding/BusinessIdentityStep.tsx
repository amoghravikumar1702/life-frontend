      ...
      <div className="relative px-6 py-8 sm:px-10 sm:py-10">
        ...
        <div className="mt-8">
          ...
          <p className="mt-3 max-w-xl text-sm leading-7 text-zinc-500">
            ArkenOne uses this information to build
            your financial command center and give
            your AI CFO the right context.
          </p>
        </div>
        ...
        <div className="mt-8 grid gap-5 sm:grid-cols-2">
          <div>
            ...
            <div className="flex items-center rounded-xl border border-white/[0.07] bg-black/20 px-4 focus-within:border-[#D4AF37]/35">
              <Building2
                size={17}
        ...
        <div className="mt-6">
          <label className="mb-3 block text-[10px] font-semibold uppercase tracking-[0.2em] text-zinc-600">
            Business Model
          </label>
            ...
            {businessModels.map((model) => {
              ...
              return (
                <button
                  ...
                  className={`min-h-12 rounded-xl border px-3 text-left text-xs transition ${
                    selected
        ...
        <div className="mt-6">
          ...
          <div className="flex max-w-sm items-center rounded-xl border border-white/[0.07] bg-black/20 px-4 focus-within:border-[#D4AF37]/35">
            <Users
              size={17}
              className="mr-3 shrink-0 text-zinc-600"
              strokeWidth={1.7}
