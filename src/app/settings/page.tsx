...
export default function SettingsPage() {
  ...
  async function changeCurrency(
    ...
    const previousValue = settings.currency;
      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <div className="mt-6 space-y-6">
          ...
          <Section
            ...
            description="Manage your personal DhanarkOS account."
          >
            <div className="divide-y divide-white/[0.06]">
              ...
              <SettingRow
                title="Email address"
                description="The email address associated with your authenticated DhanarkOS account."
              >
          ...
          >
            <div className="divide-y divide-white/[0.06]">
              ...
              <SettingRow
                ...
                description="Receive important financial intelligence generated by DhanarkOSOS AI CFO."
              >
                <Toggle
                  checked={
          ...
          <Section
            ...
            description="Control how financial information is displayed across DhanarkOS."
          >
            <div className="divide-y divide-white/[0.06]">
          ...
          <Section
            ...
            description="Keep your DhanarkOS account protected."
          >
            <div className="divide-y divide-white/[0.06]">
              ...
              <SettingRow
                title="Privacy"
                description="Review how DhanarkOS handles account and business information."
              >
                <Link
                  href="/privacy"
              ...
              <SettingRow
                title="Terms"
                description="Review the terms governing your use of DhanarkOS."
                last
              >
                <Link
                  href="/terms"
          ...
          <Section
            ...
            eyebrow="Appearance"
            title="Interface"
            description="DhanarkOS currently uses its Executive Glass interface across the workspace."
          >
          ...
          >
            <div className="divide-y divide-white/[0.06]">
              ...
              <SettingRow
                title="Version"
                description="Current DhanarkOS application version."
              >
              ...
              <SettingRow
                ...
                description="The terms governing use of the DhanarkOS platform."
              >
                <Link
                  href="/terms"
                  className="text-xs font-medium text-[#D4AF37] hover:text-[#E8C75A]"
