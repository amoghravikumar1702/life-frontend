      ...
      <main className="flex min-h-screen items-center justify-center px-6">
        <GlassPanel className="w-full max-w-lg p-10 text-center">
          ...
          <p className="mt-3 text-[var(--text-secondary)]">
            The invoice you are looking for either does not exist
            or has been removed.
          </p>
    ...
    <main className="min-h-screen">
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        <section className="mt-8 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          ...
          <KPICard
            title="Invoice Value"
            value={`₹${Number(invoice.total).toLocaleString("en-IN")}`}
            icon={<IndianRupee size={22} />}
          />

          <KPICard
            title="Amount Paid"
            value={`₹${Number(invoice.amount_paid ?? 0).toLocaleString("en-IN")}`}
            icon={<Wallet size={22} />}
          />

          <KPICard
            title="Balance Due"
            value={`₹${Number(invoice.balance_due ?? 0).toLocaleString("en-IN")}`}
        ...
        <div className="mt-8">
          ...
          <GlassPanel className="p-8">
            ...
            <PageHeader
                          title="Invoice Summary" subtitle={""}            />
