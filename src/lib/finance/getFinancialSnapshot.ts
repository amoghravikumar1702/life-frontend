...
export async function getFinancialSnapshot(): Promise<FinancialSnapshot> {
   ...
   * ============================================================
   *
   * Starting revenue represents the business position before
   * ArkenOne onboarding.
   *
   * Only invoices created after onboarding are added on top.
   *
   * This prevents the same historical revenue from being
   * counted twice.
   */
  ...
  const invoiceRevenue =
    (invoices ?? []).reduce(
      (sum, invoice) => {
        ...
        /*
         * If onboarding timestamp exists,
         * only count invoices created afterwards.
         */
   ...
   * ============================================================
   *
   * Historical starting revenue
   * +
   * new ArkenOne revenue
   */
